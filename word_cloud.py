...
#In this example, your final dictionary should include one "Add" or "add" with a value of 22. Make reasonable (not necessarily perfect) decisions about cases like "After" and "Dana".
...
# print(word_cloud_data('Add milk and eggs, then add flour and sugar.'))